...
parser.add_argument("--pheno", default="./data/pheno.txt", help="Training phenotype *.txt file (m x i matrix)")
parser.add_argument("--st", nargs="+", default=None, help="Source domain traits, n=2")
parser.add_argument("--tt", default=None, help="Target domain trait, n=1")
...
parser.add_argument("--pretrain_epoch", nargs="+", default=[40,], help="Pretraining epoch")
...
parser.add_argument("--ft_epoch", nargs="+", default=[40,], help="Fine-turning epoch")
...
parser.add_argument("--fu_epoch", nargs="+", default=[40,], help="Fusion epoch")
...
parser.add_argument("--direct_epoch", nargs="+", default=[40,], help="Direct prediction epoch")
